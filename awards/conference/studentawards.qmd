...
submission-info:
  ...
  deadline: "February 22, `r if (Sys.Date() > lubridate::mdy(paste('February 22', lubridate::year(Sys.Date())))) lubridate::year(Sys.Date()) + 1 else lubridate::year(Sys.Date())`"
links:
- icon: info-circle
  name: Learn More
...
::: callout-note
# `r format(lubridate::today() + lubridate::years(1), '%Y')` American Psychology-Law Conference

Student members with an accepted first author presentation for the `r format(lubridate::today() + lubridate::years(1), '%Y')` AP-LS Conference are eligible and highly encouraged to apply for a Student Presentation Award.

The AP-LS Student Committee will be awarding ten (10) student presentation awards at the `r format(lubridate::today() + lubridate::years(1), '%Y')` AP-LS Conference, totaling \$1,750. These awards include:
