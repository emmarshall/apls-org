...
::: callout-note
A complete application must be submitted by email to the Chair of the Undergraduate Grants-in-Aid Committee, Lauren Kois, at `lekois@ua.edu` by 11:59 p.m. PST on the date of the identified submission deadline.   
```{r}
#| echo: false
#| output: asis
...
links <- tibble(
  icon = c("circle-info", "file-export"),
  text = c("About Undergraduate Research Grants-in-Aid Committee", "Submit"),
  url = c("../../about/committees.qmd", "mailto:lekois@ua.edu")
)
...
-   Awards are limited to current undergraduate students who are active [Student Affiliate]("../../membership/membership.qmd") members of AP-LS.
...
<a class="btn btn-primary" href="mailto:lekois@ua.edu" role="button"> Submit Here</a>
