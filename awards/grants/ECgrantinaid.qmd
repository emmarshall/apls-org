...
submission-info:
  ...
  deadline: 
    - "May 19, `r if (Sys.Date() > lubridate::mdy(paste('October 31', lubridate::year(Sys.Date())))) lubridate::year(Sys.Date()) + 1 else lubridate::year(Sys.Date())`"
links:
- icon: envelope-at
  name: Contact
...
Submit a complete proposal to the online portal by the appropriate deadline on 

May 19, `r if (Sys.Date() > lubridate::mdy(paste('October 31', lubridate::year(Sys.Date())))) lubridate::year(Sys.Date()) + 1 else lubridate::year(Sys.Date())` at 11:59 PST.
