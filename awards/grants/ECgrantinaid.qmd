...
submission-info:
  ...
  deadline: "October 31, `r if (Sys.Date() > lubridate::mdy(paste('October 31', lubridate::year(Sys.Date())))) lubridate::year(Sys.Date()) + 1 else lubridate::year(Sys.Date())`"
links:
- icon: envelope-at
  name: Contact
...
Submit a complete proposal to the online portal by October 31, `r format(Sys.Date(), '%Y')` at 11:59 PST.
