...
submission-info: 
  ...
  deadline: October 15 (Pre-proposal) & December 16 (Full-proposal)
---
...
::: callout-note
Applications should be submitted via the [AP-LS Awards Portal](https://awards.ap-ls.org/default.asp) before the annual October 15 (11:59 pm PST) deadline.
...
links <- tibble(
  ...
  text = c("About Research Committee", "Contact", "Link to apply"),
  url = c("../../about/committees.html", "mailto:Colleen.berryessa@rutgers.edu", "https://awards.ap-ls.org/default.asp")
)
...
At least one of the co-PIs needs to be an [AP-LS member](../../membership/membership.html).


## Pre-Proposal Process

Interested researchers should submit a 1,000-word prospectus to the committee by October 15 at 11:59 p.m. PST. All materials are submitted through the Div. 41 (AP-LS) awards page.
