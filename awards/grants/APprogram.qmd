...
:::{callout-tip}
The research proposal should include the following, to the extent possible:
-   brief introduction/background to the project
-   brief description of the method, including participants, measures, and procedures
:::
