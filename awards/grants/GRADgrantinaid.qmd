...
links <- tibble(
  ...
  text = c("About Graduate Student Grants-in-Aid Committee", "Contact", "Link to apply"),
  url = c("../../about/committees.html", "mailto:grantsinaid@apls.org", "https://awards.ap-ls.org/default.asp")
)
