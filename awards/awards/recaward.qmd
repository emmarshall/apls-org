...
::: callout-note
Applications should be emailed directly to the Chair of the Practice Committee at `practice@ap-ls.org` before annual November 1 deadline.  
...
links <- tibble(
  ...
  url = c("../../about/committees.html", "mailto:practice@ap-ls.org")
)
