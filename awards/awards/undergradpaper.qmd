...
::: callout-note
Submissions must be in Microsoft Word format and emailed to the Chair of the Undergraduate Paper Award Committee at `undergrad_paper@ap-ls.org` before the annual June 30 deadline. 
```{r}
#| echo: false
#| output: asis
...
links <- tibble(
  ...
  text = c("About Undergraduate Paper Committee", "Contact", "Submit"),
  url = c("../../about/committees.html", "mailto:undergrad_paper@ap-ls.org", "mailto:undergrad_paper@ap-ls.org")
)
