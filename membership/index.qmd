...
<p class="display-2"><span class="currency">$</span>100<span class="period">/year</span></p>
</div>
...
<a href="https://apls.memberclicks.net/membership-form#!/" class="price-btn price-btn-gradient mt-2">Join now</a>
</div>
</div>
</div>
:::
...
<div class="card-body d-flex flex-column">
<div class="price-card-header">
<p class="display-2"><span class="currency">$</span>30<span class="period">/year</span></p>
</div>
<div class="price-card-block">
