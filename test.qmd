...
<a href="about/about.html" class="card-link heading-font">LEARN MORE</a>
:::
:::
:::
:::
...
my_cal <- march |> 
  ...
  mutate(Wednesday = ifelse(Wednesday == "1",paste0('<p>',Saturday,'</p>', 
                                                   '<p style="color:black;font-size:12px"><a href="#event-test">Event</a></p>'),Wednesday))  |> 
  
  #End of 2020
  mutate(Thursday = ifelse(Thursday == "9",paste0('<p>',Saturday,'</p>', 
                                                   '<p style="color:red;font-size:12px"><a href="#event-test">Event</a></p>'),
                           Thursday))  |> 
  
  #Volunteering
  mutate(Saturday = ifelse(Saturday == "4", paste0('<p>',Saturday,'</p>', 
                                                   '<p style="color:red;font-size:12px"><a href="#event-test">Event</a></p>'), Saturday)) |> 
  
  #Meetings
  mutate(Friday = ifelse(Friday %in% c("10","24") ,paste0('<p>',Friday,'</p>',
                                                         '<p><img src="events/images/logo_y.png" height="22"></img></p>'),Friday))  
