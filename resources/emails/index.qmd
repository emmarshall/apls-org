---
title: "Email List"
description: "The AP-LS email address list will be open to AP-LS members for participation in a research project, calls for papers and information about workshops and conferences."
categories:
  - email
---
...
If you have any questions, contact the website editor [Lindsey Wylie](webmaster@ap-ls.org)

```{=html}
<div class="card text-primary bg-secondary mb-3" style="max-width: 20rem;">
<div class="card-header">Contact info</div>
  <div class="card-body">
    <p class="card-text">AP-LS Web Editor<br>webmaster@ap-ls.org</p>
  </div>
</div>
```
