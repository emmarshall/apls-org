...
::: hero-buttons
[Submit a Proposal](https://ap-ls2026.exordo.com/){.button-17 .btn-guide role="button"} [Submit for Preconference](https://docs.google.com/forms/d/e/1FAIpQLScCMpSZYxr6JKElDfZIGK8DQHUJ3bgt0CYmfRm5mcmVxrsBYQ/viewform?usp=send_form){.button-17 role="button"}
:::
::::
:::::
::::::
...
[Annual Conference of the American Psychology-Law Society (AP-LS) <br> March 12-14, 2026 \| Reno, NV]{.event-time}
...
All proposals must be submitted on the conference website by <br> [Wednesday, October 15, 2025, 11:59 pm PST]{.session-time} <br>

[Visit the Ex Ordo portal here](https://ap-ls2026.exordo.com/) to register, <br> submit your proposals, AND sign up as a reviewer!
...
There will be **no extension** to the abstract submission deadline!
:::
