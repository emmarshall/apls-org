...
::: content-block-blue
### The 2024 APLS Annual Conference DRAFT Program is now available! 

[View Program {{< fa arrow-right >}}](https://drive.google.com/file/d/11XKPQH2qxnAYYbv0X5vNr1I2FfTPvf9e/view?usp=sharing){.btn-action .btn .btn-secondary .btn-lg role="button"}
...
<div class="mt-4 d-flex flex-row flex-wrap gap-1 justify-content-center justify-content-sm-start" role="group" aria-label="PDF Links">
<a href="https://drive.google.com/file/d/11XKPQH2qxnAYYbv0X5vNr1I2FfTPvf9e/view?usp=sharing" class="btn btn-outline-primary"><i class="bi bi-file-earmark-pdf me-1"></i> Download </a>
</div>
...
```{=html}
<iframe class="news ar4x3" src="files/AP-LS_2024_Conference_Program_Grid_DRAFT.pdf" title="DRAFT Program Grid"></iframe>
```
