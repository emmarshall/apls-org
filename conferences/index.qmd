...
<center>[{{< fa map aria-hidden="true" >}} Plan your trip](https://www.worldhotels.com/content/luxury-hotels/en_US/book/hotels-in-reno/peppermill-resort-spa-casino/propertyCode.29095.html){.btn .btn-outline-primary role="button"} [{{< fa location-dot aria-hidden="true" >}} Map](https://maps.app.goo.gl/Fa5b26tUKbZRk8Eu5){.btn .btn-outline-primary role="button"}</center>
