...
![](images/ap-ls-cover-2023){fig-align="center" width="160"}
:::
...
<div class="d-flex flex-wrap justify-content-start align-items-center">
  [Download guidebook](https://guidebook.com/g/#/guides/apls2023/details){.btn .btn-outline-primary role="button"}
  {{< downloadthis files/2023_APLS_program_grid_final.pdf dname:"program-grid" label="Download pdf" icon=file-pdf type=primary >}}
</div>
...
tbl_grid <- reactable(sd, 
              ...
              columns = list(
                ...
                img = colDef(
                  minWidth = 110,
                  name = "",
                  cell = embed_img(grid, height = 100, width = 100)
                             ),
                title = colDef(
...
tbl <- tbl_grid |> 
  ...
  htmlwidgets::prependContent(
    tagList(
      ...
      tags$h3("Schedule at a glance", style="font-family:Chivo;margin-bottom:20px;margin-top:0;font-weight:400;color:#8C8C8C;padding-left:40px;")
  )
  ) |> 
  #footnote and source
...
bscols(
  ...
  list(
    tags$div(
      ...
      filter_select("CE", "CE CREDITS", sd, ~CE),
      style = "font-size:20px;margin-top: 130px;margin-left: 20px;"
    )
  ),
