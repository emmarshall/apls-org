...
::: session-description
We invite proposal submissions for the 2027 Annual Conference of AP-LS. We strongly encourage empirically based proposals, proposals that involve new and emerging topics within psychology and law, and proposals that incorporate historically marginalized or underrepresented populations.
...
{{< fa plane aria-hidden="true" >}} ***Recommended Transportation***<br> 
...
{{< fa credit-card aria-hidden="true" >}} Group Rate \$259 to 559 USD/night </br> {{< fa calendar aria-hidden="true" >}} Available March 6 - March 18 </br> {{< fa square-parking aria-hidden="true" >}} Discounted Valet Parking (\$38/ night)
