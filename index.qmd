...
::: about-link
[MORE FROM THE PRESIDENT](president/index.html)
:::
...
::: {.content-block-blue}
### Get ready for the 2023 American Psychology-Law Society Conference

Philadelphia, PA---March 16-18

[Learn More](conferences/index.html){.btn-action .btn .btn-secondary .btn-lg role="button"}
:::
:::
...
content = rowwise_table(~name, ~icon, ~link,
  ...
  "Newsletter", "newspaper", "resources/newsletter/2023/feb2023.html",
    "Job Postings", "briefcase-fill", "resources/job_postings/index.html", 
    "APA", "award-fill", "https://convention.apa.org/future-conventions",
    "Videos", "mortarboard-fill", "resources/videos/index.html"
)
div(class = "bg-light",
 div(class = "bg-breakout",
    div(class = "inner-container",
