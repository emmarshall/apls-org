...
[Learn more {{< fa arrow-right >}}](membership/index.html){.btn-action .btn .btn-secondary .btn-lg role="button"}
:::
:::
::: vspace
:::
...
<div class="p-3 text-center rounded-circle m-1 shadow-lg" style="background-size: cover; background-image: url({image}); width: 225px; height: 225px">
...
#| message: false
content = rowwise_table(~name, ~icon, ~link,
                        "Publications", "chat-dots", "publications/index.html",
  "Newsletter", "newspaper", "resources/newsletter/index.html",
    "Job Posts", "briefcase-fill", "resources/job-postings/index.html", 
